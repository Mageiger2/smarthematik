...
const ZerfallsTrainer = () => {
    ...
    const generateProblem = () => {
        ...
        if (difficulty === 'schwer') { t = Math.floor(Math.random() * 12) + 5; thalf = Math.floor(Math.random() * 5) + 2; }
    ...
    return (
        <div className="page-transition max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <DifficultyMenu theme="rose" active={difficulty} onChange={handleDifficultyChange} options={[{id: 'normal', label: 'Normal'}, {id: 'schwer', label: 'Schwer'}]} />
            ...
            <main className="space-y-6 relative">
                ...
                <div className="space-y-4">
                    ...
                    {step === 5 && (
                        <SuccessBox showSolutionBtn={true} showSolution={showSolution} onToggleSolution={() => setShowSolution(!showSolution)} onNext={generateProblem} solutionText={problem.explanation} theme="rose" />
                    )}
                </div>
            </main>
        </div>
